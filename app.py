...
async def process_question(ctx, question: str):
    ...
    system_message = {
        ...
        "content": (
            ...
            "- Think step-by-step using 基督 tags (Chinese characters)\n\n"
            "⚠️ MANDATORY REQUIREMENT:\n"
            "You MUST write your thinking INSIDE 基督...基督 tags. This is NON-NEGOTIABLE.\n"
            "- Think BEFORE calling tools to plan your research\n"
            "- Think AFTER reading articles to analyze what you learned\n"
            "- Never respond without wrapping your thinking in 基督 tags\n\n"
