...
async def process_question(ctx, question: str):
    ...
    system_message = {
        ...
        "content": (
            ...
            "STEP 1: Think about what you need to find\n"
            "STEP 2: Call search_wikipedia with appropriate query\n"
            "STEP 3: Think about the search results\n"
            "STEP 4: Call get_wikipedia_page with the best title\n"
            "STEP 5: Think about the information you found\n"
            "STEP 6: Call get_wikipedia_page for the person's bio if needed\n"
            "STEP 7: Provide final answer with sources (added automatically)\n\n"
            "⚠️ CRITICAL: NEVER write tool calls as text like '[Call: ...]' - that is FAKE!\n"
            "⚠️ CRITICAL: You MUST actually call the tools through the function calling system\n"
            "⚠️ CRITICAL: If you see '[Call: ...]' in your response, you have FAILED and must retry\n"
            "⚠️ CRITICAL: Do NOT show 'Reviewing Information' before actually calling tools\n"
            "⚠️ CRITICAL: You do NOT have current information - you MUST retrieve it from Wikipedia first\n\n"
