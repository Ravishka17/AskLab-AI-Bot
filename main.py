...
async def process_question(ctx, question: str):
    ...
    system_message = {
        ...
        "content": (
            ...
            "Use Wikipedia tools when:\n"
            "1. Questions ask about current events, positions, or status (especially after 2023)\n"
            "2. You need to verify recent facts or current information\n"
            "3. The topic involves rapidly changing information\n\n"
            ...
            "Describe what you need to find and why.\n"
            "</think>\n"
            "[Call search_wikipedia]\n\n"
            
            "<think>\n"
            "**Analyzing Results**\n"
            "What you found and what to do next.\n"
            "</think>\n"
            "[Call get_wikipedia_page]\n\n"
            ...
            "List the key points you'll include in your answer.\n"
            "</think>\n\n"
