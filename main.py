...
async def process_question(ctx, question: str):
    ...
    system_message = {
        ...
        "content": (
            ...
            "I need to search Wikipedia for current information about Sri Lanka's president.\n"
            "基督\n\n"
            "[NOW I call search_wikipedia with query='current president of Sri Lanka']\n\n"
            "基督\n"
            "**Analyzing Search Results**\n"
            "I see 'President of Sri Lanka' in the results. Now I'll read this page.\n"
            "**Planning Next Step**\n"
            "Call get_wikipedia_page with title='President of Sri Lanka'\n"
            "基督\n\n"
            "[NOW I call get_wikipedia_page and get back the article content]\n\n"
            "基督\n"
            "**Reviewing Article Content**\n"
            "Found current president is Anura Kumara Dissanayake. Need his bio too.\n"
            "**Next Research Step**\n"
            "Search for 'Anura Kumara Dissanayake'\n"
            "基督\n\n"
            "[NOW I search and read his biography page]\n\n"
            "基督\n"
            "**Synthesizing Complete Information**\n"
            "From both articles: Current president is Anura Kumara Dissanayake.\n"
            "**Ready to Answer**\n"
            "I have all necessary information.\n"
            "基督\n\n"
            "[NOW provide final answer below]\n\n"
            
            "⚠️ CRITICAL WARNINGS:\n"
            "- Do NOT use <function_call>, <think>, or other fake XML tags. Only use 基督 tags.\n"
            "- Do NOT describe tool calls - actually MAKE them through the API.\n"
            "- Thinking in plain text is WRONG and will be rejected.\n"
            "- NEVER write fake markers like '<|tool_calls_section_begin|>'\n"
            "- Thinking happens in 基督 tags, tool calls happen separately."
    ...
    try:
        async with ctx.typing():
            ...
            while iteration < max_iterations:
                ...
                # Check if we have tool calls - if so, we need thinking
                ...
                # If no tool calls and no thinking, this could be a direct answer - let it through
